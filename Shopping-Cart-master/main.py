...
stripe_keys = {
  'secret_key': 'sk_test_iCxjeVerVd4YjAElS2S7x56F',
  'publishable_key':'pk_test_JOLG7R95tSt6r2GbwFmRdNFu'
}
...
def checkout():
    ...
    return render_template('checkout.html', key=stripe_keys['publishable_key'],totalPrice=totalPrice)
